...
for (c in countries) {
  # print(c)
  if (c %in% c("Afghanistan", "Antigua and Barbuda", "Bhutan", "Bonaire Sint Eustatius and Saba", "Botswana", "Cameroon", "Cote d'Ivoire", "Democratic Republic of Congo", "Ethiopia", "Gabon", "Ghana", "Guernsey", "Guinea", "Kenya", "Kuwait", "Liberia", "Namibia", "Nepal", "Niger", "Nigeria", "Palestine", "Philippines", "Pitcairn", "Rwanda", "Saint Helena", "Senegal", "Somalia", "South Sudan", "Sudan", "Tokelau", "Turkmenistan", "Uganda", "World", "Zambia")) {
    next
  }
