...
```{r variable-list, fig.cap="Selected variables"}
...
```{r vri-result-summary, fig.cap="VRI results summary"}
df_sum <- round(data.frame(unclass(summary(vri_data$vri))),6)
df_sum
```
...
```{r vri-eval-table, fig.cap="VRI time evaluation result"}
vri_eval_table
```
